import {
  ...
  import { IconUsers, IconTools, IconDeviceLaptop, IconHelp } from '@tabler/icons';
  ...
  export function FeaturesCards() {
    ...
    return (
      <Container size="lg" py="xl">
        ...
        Are you struggling to understand and communicate with your team of developers ? TECHSENSE is the easiest way to upskill and get the tech knowledge you need.
        </Text> */}
